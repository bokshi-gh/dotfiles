...
- It appends the key automatically to ~/.ssh/authorized_keys. You only need to enter your password once; afterward, passwordless login works.
- If `i` is not provided it will use `.ssh/id_rsa.pub`.
